...
key_token = "6217242454:AAGBO4HzP-y_sTHo1HDr6I2J-DUZi69kUyY" #Masukkan KEY-TOKEN BOT 
user_bot = "fachryyyyybot" #Masukkan @user bot
...
async def  text_massage(update: Update, context:ContextTypes.DEFAULT_TYPE):
    ...
    if 'halo' in text_lwr_diterima:
        ...
        await update.message.reply_text("Selamat pagi..., semangat ya untuk hari ini 😊")
